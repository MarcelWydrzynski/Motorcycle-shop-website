...
const ProductPageProductCard = ({ motorcycle }) => {

  return (
    <div className="rounded flex flex-col group hover:bg-primaryRed cursor-pointer ease-in-out duration-75 px-2 py-4 bg-lightGrey max-w-72 min-[1550px]:max-w-96">
      <div>
        <img
